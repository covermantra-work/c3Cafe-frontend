          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#133e3b] border border-[#1a4a46] text-xs font-semibold text-stone-200 hover:border-[#e05326] hover:text-[#ff8159] transition-all"
              >
